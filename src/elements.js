export const stackText = document.querySelector(".stack__text");
export const stackItems = [...document.querySelectorAll(".stack__item")];
export const contactName = document.querySelector(".contact__name");
